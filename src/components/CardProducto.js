    ...
    return (
        <Card className='m-4' style={{ maxWidth: ancho_max }} key={producto.id + producto.title} >
            ...
            <ListGroup className='list-group-flush'>
                {props.detalle ? <ListGroup.Item><Link to='/coder-react/productos' >Volver a productos</Link> </ListGroup.Item> : <ListGroup.Item><Link to={'/coder-react/item/' + producto.id}>Ver detalle</Link> </ListGroup.Item>}
